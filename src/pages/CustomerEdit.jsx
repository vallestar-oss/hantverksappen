  ...
  return (
    <div className="min-h-screen bg-gray-50">
      <header className="bg-white border-b border-gray-100 px-4 py-4 flex items-center gap-3 sticky top-0 z-10">
        ...
        <h1 className="font-bold text-gray-800 text-lg">Redigera kund</h1>
      </header>
      ...
      <form onSubmit={handleSubmit} className="max-w-lg mx-auto px-4 py-6 space-y-4 pb-20">
        ...
        <button
          ...
          disabled={saving || deleting}
          className="w-full bg-white hover:bg-red-50 active:bg-red-100 disabled:opacity-60 text-danger border border-danger/30 font-semibold py-3 rounded-xl transition-colors duration-150"
        >
